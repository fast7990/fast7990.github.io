...
const items = [
    {
        ...
        message:
            "“我是个拥有梦想技术小白，但是网络坑太多，别人分享的源码都是残次品，完整的都要收费！于是我在Github搜索，终于我找到了我想要的里bag-admin开源博客系统，这款系统非常好，界面非常美观，最主要的的是，作者也非常nice，不收费。于是我快速搭建了一个属于自己的lcm博客，心里的酸爽！不过还是有点缺陷，我相信作者君会好好完善的！加油Bag，良心的系统！.”"
    },
    {
        name: "昏睡的冥王星",
