...
function SetLoginBar(params){
	if( params.MemberID ){
		...
		$("#tool .MemberCenter").attr("href", params.MemberLoginUrl);
	}
...
function setEmptyText(total){
	if( total <= 0 ){
		$(".body_shoppingcart .cart_table tbody tr").remove();
		$(".body_shoppingcart .cart_table tfoot").show();
		$(".body_shoppingcart .cart_table tbody").hide(); //兼容firefox
	}else{
		$(".body_shoppingcart .cart_table tfoot").hide();
		$(".body_shoppingcart .cart_table tbody").show(); //兼容firefox
	}
}
